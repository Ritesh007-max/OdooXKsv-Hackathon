...
const RFQsView = () => {
  ...
  return (
    <main className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
      {/* Header section */}
      <div>
        <h1 className="text-display font-sans font-bold mb-1">Create RFQ's</h1>
      ...
      <div className="flex items-center w-full my-4">
        <div className="flex items-center justify-center w-8 h-8 rounded-full border-2 border-primary text-primary font-bold bg-white">1</div>
        <div className="flex-1 h-0.5 bg-gray-300 mx-2"></div>
        <div className="flex items-center justify-center w-8 h-8 rounded-full border-2 border-gray-400 text-gray-400 font-bold bg-white">2</div>
        <div className="flex-1 h-0.5 bg-gray-300 mx-2"></div>
        <div className="flex items-center justify-center w-8 h-8 rounded-full border-2 border-gray-400 text-gray-400 font-bold bg-white">3</div>
      </div>

      {/* Two Column Layout */}
      <div className="flex flex-col lg:flex-row gap-12 border-b border-gray-300 pb-8">
